...
public class SetupMockTemperatureMeasurements {
	...
	public void setUp() {
		...
		List<LocalDate> dates = List.of(LocalDate.parse("2022-09-01", DATE_FORMATTER),
				LocalDate.parse("2022-09-02", DATE_FORMATTER), LocalDate.parse("2022-09-03", DATE_FORMATTER),
				LocalDate.parse("2022-09-04", DATE_FORMATTER), LocalDate.parse("2022-09-05", DATE_FORMATTER),
				LocalDate.parse("2022-09-06", DATE_FORMATTER), LocalDate.parse("2022-09-07", DATE_FORMATTER),
				LocalDate.parse("2022-10-03", DATE_FORMATTER), LocalDate.parse("2022-10-04", DATE_FORMATTER),
				LocalDate.parse("2022-10-05", DATE_FORMATTER));

		List<String> cities = List.of("pune", "jalandhar", "hoshiarpur", "mumbai", "bangalore", "amritsar", "noida",
				"gurgaon", "nagpur", "delhi");
		...
		for (int i = 1; i <= total; i++) {
			...
			if (i % batchSize == 0) {
				log.info("Processing temperatures batch " + batch + ". Progress = "
